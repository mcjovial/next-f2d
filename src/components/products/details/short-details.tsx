  ...
  return (
    ...
    >
      <div className="flex items-center">
        <div
          className={cn(
            'relative flex shrink-0 items-center justify-center overflow-hidden rounded border border-border-200 border-opacity-70 h-28 w-28',
          )}
        >
          <Image
            src={image}
        ...
        <div
          className={cn('flex w-full shrink-0 max-w-max')}
        >
